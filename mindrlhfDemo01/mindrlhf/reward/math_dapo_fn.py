...
"""Reward functions for GRPO training on DAPO 17k dataset."""
import re
import signal
...
def math_dapo_reward(prompts, completions, solution, **kwargs):
    rewards = []
    for i in range(len(completions)):
        solution_str = completions[i]
        ground_truth = solution[i]
        res = compute_score(solution_str=solution_str, ground_truth=ground_truth)
